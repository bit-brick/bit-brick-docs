        ...
        <div className="ast-builder-footer-grid-columns site-above-footer-inner-wrap ast-builder-grid-row">
          <div className="site-footer-above-section-1 site-footer-section site-footer-section-1">
            <aside className="footer-widget-area widget-area site-footer-focus-item footer-widget-area-inner" data-section="sidebar-widgets-footer-widget-3" aria-label="Footer Widget 3">
              ...
              <section id="block-55" className="widget widget_block widget_text">
                <p className="has-ast-global-color-2-color has-text-color has-link-color wp-elements-30db9d4d641d4dcacec571df20354f4b">We want to create something to help people understand the basic operating principles of technology</p>
              </section>
            </aside>
          </div>
          <div className="site-footer-above-section-2 site-footer-section site-footer-section-2">
            <aside className="footer-widget-area widget-area site-footer-focus-item footer-widget-area-inner" data-section="sidebar-widgets-footer-widget-2" aria-label="Footer Widget 2">
              <section id="block-13" className="widget widget_block">
                <h5 className="wp-block-heading has-medium-font-size">Follow us</h5>
              </section>
              <section id="block-52" className="widget widget_block">
                <ul className="wp-block-social-links has-normal-icon-size has-visible-labels has-icon-color is-style-logos-only is-vertical is-content-justification-left is-layout-flex wp-container-core-social-links-is-layout-1 wp-block-social-links-is-layout-flex">
                  <li style={{color: 'var(--ast-global-color-8)'}} className="wp-social-link wp-social-link-instagram has-ast-global-color-8-color wp-block-social-link">
                    <a href="https:///" className="wp-block-social-link-anchor">
                      ...
                      <span className="wp-block-social-link-label">Instagram</span>
                    </a>
                  </li>
                  <li style={{color: 'var(--ast-global-color-8)'}} className="wp-social-link wp-social-link-facebook has-ast-global-color-8-color wp-block-social-link">
                    <a href="https:///" className="wp-block-social-link-anchor">
                      <svg width="24" height="24" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                        <path d="M12 2C6.5 2 2 6.5 2 12c0 5 3.7 9.1 8.4 9.9v-7H7.9V12h2.5V9.8c0-2.5 1.5-3.9 3.8-3.9 1.1 0 2.2.2 2.2.2v2.5h-1.3c-1.2 0-1.6.8-1.6 1.6V12h2.8l-.4 2.9h-2.3v7C18.3 21.1 22 17 22 12c0-5.5-4.5-10-10-10z"></path>
                      </svg>
                      <span className="wp-block-social-link-label">Facebook</span>
                    </a>
                  </li>
                  <li style={{color: 'var(--ast-global-color-8)'}} className="wp-social-link wp-social-link-twitter has-ast-global-color-8-color wp-block-social-link">
                    <a href="https:///" className="wp-block-social-link-anchor">
                      <svg width="24" height="24" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                      ...
                      <span className="wp-block-social-link-label">Twitter</span>
                    </a>
                  </li>
                  <li style={{color: 'var(--ast-global-color-8)'}} className="wp-social-link wp-social-link-tiktok has-ast-global-color-8-color wp-block-social-link">
                    <a href="https:///" className="wp-block-social-link-anchor">
                      ...
                      <span className="wp-block-social-link-label">TikTok</span>
                    </a>
                  </li>
                  <li style={{color: 'var(--ast-global-color-8)'}} className="wp-social-link wp-social-link-youtube has-ast-global-color-8-color wp-block-social-link">
                    <a href="https:///" className="wp-block-social-link-anchor">
                      <svg width="24" height="24" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                        <path d="M21.8,8.001c0,0-0.195-1.378-0.795-1.985c-0.76-0.797-1.613-0.801-2.004-0.847c-2.799-0.202-6.997-0.202-6.997-0.202 h-0.009c0,0-4.198,0-6.997,0.202C4.608,5.216,3.756,5.22,2.995,6.016C2.395,6.623,2.2,8.001,2.2,8.001S2,9.62,2,11.238v1.517 c0,1.618,0.2,3.237,0.2,3.237s0.195,1.378,0.795,1.985c0.761,0.797,1.76,0.771,2.205,0.855c1.6,0.153,6.8,0.201,6.8,0.201 s4.203-0.006,7.001-0.209c0.391-0.047,1.243-0.051,2.004-0.847c0.6-0.607,0.795-1.985,0.795-1.985s0.2-1.618,0.2-3.237v-1.517 C22,9.62,21.8,8.001,21.8,8.001z M9.935,14.594l-0.001-5.62l5.404,2.82L9.935,14.594z"></path>
                      </svg>
                      <span className="wp-block-social-link-label">YouTube</span>
                    </a>
                  </li>
                </ul>
              </section>
              ...
              <section id="block-12" className="widget widget_block">
                <div className="wp-block-group is-layout-constrained wp-block-group-is-layout-constrained">
                  <div className="widget widget_nav_menu">
                    <nav className="menu-%e4%b8%bb%e8%a6%81-container" aria-label="Menu">
                      <ul id="menu-%e4%b8%bb%e8%a6%81" className="menu">
                        <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-231">
          ...
          <div className="site-footer-above-section-4 site-footer-section site-footer-section-4">
            <aside className="footer-widget-area widget-area site-footer-focus-item footer-widget-area-inner" data-section="sidebar-widgets-footer-widget-4" aria-label="Footer Widget 4">
              ...
              <section id="nav_menu-3" className="widget widget_nav_menu">
                <nav className="menu-documentation-container" aria-label="Menu">
                  <ul id="menu-documentation" className="menu">
                    <li id="menu-item-383" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-383">
                      <a href="https://bit-brick-doc.readthedocs.io/" className="menu-link">Pi one product brief</a>
                    </li>
                    <li id="menu-item-384" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-384">
                      <a href="https://bit-brick-doc.readthedocs.io/" className="menu-link">Pi one mechanical drawing</a>
                    </li>
                    <li id="menu-item-385" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-385">
                      <a href="https://bit-brick-doc.readthedocs.io/" className="menu-link">Pi one getting start documentation</a>
                    </li>
                    <li id="menu-item-386" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-386">
                      <a href="https://bit-brick-doc.readthedocs.io/" className="menu-link">Pi one peripherals documentation</a>
                    </li>
                  </ul>
                </nav>
              </section>
