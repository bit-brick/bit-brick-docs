            ...
            <div className="site-footer-above-section-4 site-footer-section site-footer-section-4">
              <aside className="footer-widget-area widget-area site-footer-focus-item footer-widget-area-inner" data-section="sidebar-widgets-footer-widget-4" aria-label="Footer Widget 4">
                <section id="block-37" className="widget widget_block">
                  ...
                  <li id="menu-item-384" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-384"><a href={selectedLang == '/zh' ? "/zh/docs/k1/k1-os/desktop/os-intro":"/docs/k1/k1-os/desktop/os-intro"} className="menu-link"><Translate id='footer.url3'>K1 OS</Translate></a></li>
                  ...
                  <li id="menu-item-386" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-386"><a href={selectedLang == '/zh' ? "/zh/docs/k1/k1-hardware/hardware-brief":"/docs/k1/k1-hardware/hardware-brief"} className="menu-link"><Translate id='footer.url5'>K1 Hardware Development</Translate></a></li>
                  <li id="menu-item-386" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-386"><a href={selectedLang == '/zh' ? "/zh/docs/k1/k1-software/PINCTRL":"/docs/k1/k1-software/PINCTRL"} className="menu-link"><Translate id='footer.url5_1'>K1 Software Development</Translate></a></li>
                  <li id="menu-item-386" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-386"><a href={selectedLang == '/zh' ? "/zh/docs/k1/k1-ml/ai-arch":"/docs/k1/k1-ml/ai-arch"} className="menu-link"><Translate id='footer.url5_2'>K1 Machine Learning</Translate></a></li>
                  <li id="menu-item-386" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-386"><a href={selectedLang == '/zh' ? "/zh/docs/k1/datasheets/datasheets":"/docs/k1/datasheets/datasheets"} className="menu-link"><Translate id='footer.url5_3'>K1 Data Manual</Translate></a></li>
