            ...
            <div className="site-footer-above-section-4 site-footer-section site-footer-section-4">
              <aside className="footer-widget-area widget-area site-footer-focus-item footer-widget-area-inner" data-section="sidebar-widgets-footer-widget-4" aria-label="Footer Widget 4">
                <section id="block-37" className="widget widget_block">
                  ...
                  <li id="menu-item-388" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-388"><a href="https://github.com/bit-brick/datasheets/blob/main/K1_circuit_diagram.zip" className="menu-link"><Translate id='footer.url6'>K1 circuit diagram files</Translate></a></li>
                  <li id="menu-item-389" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-389"><a href="https://github.com/bit-brick/datasheets/blob/main/K1_Layout.zip" className="menu-link"><Translate id='footer.url7'>K1 layout files</Translate></a></li>
