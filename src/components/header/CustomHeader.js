          ...
          <div className="site-primary-header-wrap ast-builder-grid-row-container site-header-focus-item ast-container" data-section="section-primary-header-builder">
            <div className="ast-builder-grid-row ast-builder-grid-row-has-sides ast-builder-grid-row-no-center">
              ...
              <div className="site-header-primary-section-right site-header-section ast-flex ast-grid-right-section">
                      ...
                      <nav className="site-navigation ast-flex-grow-1 navigation-accessibility site-header-focus-item" id="primary-site-navigation-desktop" aria-label="Site Navigation" itemType="https://schema.org/SiteNavigationElement" itemScope>
                        <div className="main-navigation ast-inline-flex">
                          <ul id="ast-hf-menu-1" className="main-header-menu ast-menu-shadow ast-nav-menu ast-flex submenu-with-border stack-on-mobile" style={{padding: 0, margin: 0, fontSize: '15px', gap: '8px'}}>
                            ...
                            <li id="menu-item-547" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-547"><a href={selectedLang == '/zh' ? "/zh/downloads":"/downloads"} aria-current="page" className="menu-link"><Translate id='menu.downloads'>Downloads</Translate></a></li>
                ...
                <aside className="header-widget-area widget-area site-header-focus-item header-widget-area-inner" data-section="sidebar-widgets-header-widget-1" aria-label="Header Widget 1" style={{display: 'flex', alignItems: 'center', gap: '10px'}}>
                  <DocSearchButton
                  ...
                  />
                  <section id="polylang-3" className="widget widget_polylang" style={{marginBottom: 0}}>
