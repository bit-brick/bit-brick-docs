...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![Bianbu Desktop System Interface](/img/k1/os/bianbuos-en.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![Bianbu NAS System Interface](/img/k1/os/bianbu-nas-en.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![Figure 3 Bianbu System Architecture Diagram](/img/k1/os/os-arch.png)</span>
