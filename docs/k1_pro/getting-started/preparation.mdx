...
The K1 Pro consumes about 2W of power without peripherals. However, we recommend using a power adapter with 10W or higher power output (you can also power the K1 via your computer's USB port). Since the K1 single-board computer uses a TYPE-C port for power, you will need a USB TYPE-C cable.
...
| Product Model <img width="150"/>| Recommended Parameters<img width="150"/> | Reference Product |
|----------|----------|----------|
| LCD Monitor | Best resolution: 1920*1080 | <img src="/img/k1/getting-started/preparation/lcd.png" alt="lcd" width="150" /> |
