...
![Figure 1 Block Diagram of the Processor Display Subsystem](/img/k1/hardware/display-interface/display_framework.png)
...
![Figure 1 On-board MIPI DSI Interface of K1](/img/k1/hardware/display-interface/k1_hdmi.png)
...
![Figure 3 On-board MIPI DSI Interface of K1](/img/k1/hardware/display-interface/mip_ldc.png)
...
![Figure 4 Definition of K1 MIPI Display Interface](/img/k1/hardware/display-interface/display_gpio.png)
