...
![Figure 1 Schematic Diagram of the Audio Interface](/img/k1pro/hardware/k1_audio.png)
</span>
...
![Figure 2 Circuit of the Audio Part](/img/k1pro/hardware/k1_audio_io.png)
</span>
