...
![](baseurl/resource/file/images?fileName=N0bobhh5morn8pxOPA5cIAOknfe.png)
...
![](baseurl/resource/file/images?fileName=DGPfbGjSTob8xjx2Hz9cUJjNnjh.png)
...
![](baseurl/resource/file/images?fileName=Y7D5bQuhMonm86xZvlLcSRYtn9g.png)
...
![](baseurl/resource/file/images?fileName=ByxAbGy8JowdFTx79CMcr16Bnid.png)
...
![](baseurl/resource/file/images?fileName=KoBkb4zNnofjWkxIxJAcTMCFnPd.png)
...
![](baseurl/resource/file/images?fileName=WBs6bUZSdomPYuxUT9McA441nQf.png)

- 单击 Finish，工具会自动生成示例代码和相关资源，等待工程创建完成

## 3.2 项目结构

![](baseurl/resource/file/images?fileName=Mxq8baFZoo70jXx313bcgQninhh.png)
...
![](baseurl/resource/file/images?fileName=CeQLbnVnIoKJiexjaiEcWn5TnX7.png)
...
![](baseurl/resource/file/images?fileName=YbQ7bzXoLoxxHvx9VkdcMBminrh.png)
...
![](baseurl/resource/file/images?fileName=FhiTbk4NZoP4CgxW4QtcLAVTneg.png)

并将项目更改为 OpenHarmony 项目，设置 SDK 版本号

![](baseurl/resource/file/images?fileName=EEiCbDjiso9ZGqxFxc3cSzdfnEh.png)
...
![](baseurl/resource/file/images?fileName=UziHby6xloSWDPxNmm2cercMnfe.png)
