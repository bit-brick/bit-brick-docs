...
![](https://developer.spacemit.com/resource/file/images?fileName=Y7D5bQuhMonm86xZvlLcSRYtn9g.png)
...
![](https://developer.spacemit.com/resource/file/images?fileName=FhiTbk4NZoP4CgxW4QtcLAVTneg.png)

并将项目更改为 OpenHarmony 项目，设置 SDK 版本号

![](https://developer.spacemit.com/resource/file/images?fileName=EEiCbDjiso9ZGqxFxc3cSzdfnEh.png)
