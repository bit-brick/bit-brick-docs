...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![docker1](static/docker1.jpg)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![docker2](static/docker2.jpg)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![docker3](static/docker3.jpg)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![docker7](static/docker7.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![docker8](static/docker8.png)</span>

Stop running containers while preserving their state and data, which can be restored using the `docker-compose up` command.

- **docker-compose down**

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![docker9](static/docker9.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![docker10](static/docker10.png)</span>