...
- Meets Industrial grade reliability standards
   <span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![front](/img/k1/hardware/processor-brief/k1_cpu.png)</span>
## 2. Feature Overview
...
## 3. Block Diagram
       ...
       <span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![front](/img/k1/hardware/processor-brief/architecture.png)</span>