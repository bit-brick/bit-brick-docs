...
## 1. Overview
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![front](/img/k1/hardware/font.png)</span>
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![front](/img/k1/hardware/back.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![front](/img/k1/hardware/fun_front.png)</span>
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![front](/img/k1/hardware/fun_back.png)</span>
## 4. Dimension Specifications
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![front](/img/k1/hardware/fun_frame.png)</span>