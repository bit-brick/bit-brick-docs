...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![Figure 1 k1_gpio](/img/k1/hardware/k1_gpio.png)</span>
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![img](/img/k1/hardware/gpio_detail.png)</span>
## 1. Pin Definition
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![front](/img/k1/hardware/gpio/gpio_function.jpg)</span>
