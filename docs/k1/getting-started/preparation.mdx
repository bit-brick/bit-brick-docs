...
If you want to use the K1 as an entry-level desktop system, you also need to configure an HDMI screen, as well as a mouse and keyboard for it. You can use a regular computer monitor, as most monitors support HDMI. The same goes for the mouse and keyboard, as mainstream mice and keyboards are plug-and-play. You may need to confirm that the HDMI cable connected to the motherboard end must be of Type A. If you are not familiar with the HDMI interface type, you can refer to the following information:
