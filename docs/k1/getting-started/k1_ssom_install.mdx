...
Image link: [bianbu-24.04-desktop-v2.1](https://pan.baidu.com/s/1TnG3lHML6Qi0zBplCSjm_Q?pwd=yfw9). After downloading, extract the files to speed up the flashing process.
...
1. **Open titanflasher** and click "Dev Tools" to enter "USB Download".
   ...
   ![alt text](./static/ssom_k1_install_image_en.png)
   </span>
...
4. **Enter Flashing Mode**:
   ...
   ![alt text](./static/ssom_k1_install_image-2_en.png)
   </span>
...
5. **Scan Devices**:
   ...
   ![alt text](./static/ssom_k1_install_image-3_en.png)
   </span>
...
6. **Select Image Directory**:
   ...
   ![alt text](./static/ssom_k1_install_image-4_en.png)
   </span>
...
7. **Start Flashing the Image**:
   ...
   ![alt text](./static/ssom_k1_install_image-5_en.png)
   </span>
...
- Once flashing is complete, titanflasher will display a "Flashing Successful" message.
   ...
   ![alt text](./static/ssom_k1_install_image-6_en.png)
   </span>
