...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![有线网络的图](/img/k1/os/eth.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![配置的截图](/img/k1/os/wifi.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![截图来说明](/img/k1/os/package_update.png)</span>
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![截图来说明](/img/k1/os/package_update1.png)</span>
