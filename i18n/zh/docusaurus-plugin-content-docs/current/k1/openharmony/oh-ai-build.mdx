...
### **d****eepSeek-****r****1-****d****istill-****q****wen-1.5****b****-****q****4\_0.gguf**
...
![](baseurl/resource/file/images?fileName=AQ1DbbQjYogPk7xbnzWcbJrlnDd.png)
...
![](baseurl/resource/file/images?fileName=MWxZb7N6hoxGYWxrZW1c23rPnUc.png)

- 如下图，若 `list` 为空，表示模型没有安装，需要加载大模型

![](baseurl/resource/file/images?fileName=RpNqbIKVRo92PMxbuGXcvyFvned.png)

- 加载大模型

![](baseurl/resource/file/images?fileName=E4XzbkXgMoy62pxWDAvcJnSUnIg.png)

- 再查看模型列表

![](baseurl/resource/file/images?fileName=A4rAbKEoAoojqLxdKhfcDD6KnSh.png)

- 在命令行运行大模型进行对话

![](baseurl/resource/file/images?fileName=X0f3bNxbLoyy72xIQRicx5g8nEc.png)

- 打开 OH 的 HAP 程序

![](baseurl/resource/file/images?fileName=Y7vhbD6EWoxFe2xeqIScNNXynrc.jpg)

- 测试 HAP 的使用界面

![](baseurl/resource/file/images?fileName=UqXAbZb5Bo1YkSxxRkUcQFK9nth.jpg)
...
- 需要开发文件：[点我下载](https://archive.spacemit.com/tools/openharmony/ai/)（若已下载，请忽略）
  ...
  - `c``hatgpt`: 包含 OH ChatGPT 库代码与 TestNAPI 测试代码
  - `d``eepseek`：演示 HAP 代码

![](baseurl/resource/file/images?fileName=EFXobVplCozFpbx6jNGcFcDKnZg.png)
...
![](baseurl/resource/file/images?fileName=DFCpbttQxoUUZAx36Gqc6473nZg.png)
...
![](baseurl/resource/file/images?fileName=LRc7bdRm8oosKpxAzXSccCtYnjf.png)
...
![](baseurl/resource/file/images?fileName=R6O9bfkiMoGUBcxtenyc2N2hnLe.png)
...
![](baseurl/resource/file/images?fileName=Ml1Ib63Tpo06SmxiU1hcaxTFn9b.png)
...
![](baseurl/resource/file/images?fileName=YFhPbKC20obOPoxtp7Qcg4RMn5c.png)
...
![](baseurl/resource/file/images?fileName=N2iIbnsliooSsQxtKaZcprMcnWf.png)
