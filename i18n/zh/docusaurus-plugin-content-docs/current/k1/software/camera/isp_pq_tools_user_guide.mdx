...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/H9bObTXA6oxcU9xLgCWctorfn2e.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/RJ3wbCncao9oW1xqY3Fc3itinQg.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/QyG4bB7vRoxN4pxHi8ecF1WKn2d.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/VfaobKikkom8AmxikFAcFpr5nsc.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/P0oCbyHqao9Yfpxl6wScqVpCn3e.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/AXhhbCplsoM4IYxa3d6cu3p4nMd.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/TMzDbydbgoiWlYxX5XocLzHmnVf.png)</span>
...
- Value（寄存器值）
  ...
  - Write 写寄存器 / Batch Write 文件导入批量写寄存器批量读写寄存器文件格式如下，`{Address, Value }`,  批量读写寄存器点击 Batch Read / Batch Write 导入 reg_batch.txt。读取结果会在红色框中显示对应 log，同时会生成同名_read.txt 用于后续查看。
    <span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/BfTFbluLmoBmPYxTWsvceubLnCh.png)</span>

批量读写寄存器文件格式示例

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/YTMBbCIXIoLGK7xgYlic7UDon9b.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/Bv0JbfQfVoCa1NxxevYch701nIb.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/CPWGbI87NoUWSXxGp0OcvEo1nFF.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/HL7wbuzstoOKcyxjSKBce4sJngf.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/Cza4bQxuboELiHxu4Q6cu8YNnCb.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/U1RmbqcooohmnEx7d29cVkK6nfH.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/TH3Rbs3dQoiGwoxi6AMcVmtMn5e.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/O8xmbKq8soVjc8xtrebcw7n6nJf.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/Tm8ZbZsTQosPkVxDBVvcNIi5nLg.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/Wii6bCvr0osUzdxZdn2cSw5vnPd.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/A8FQbARlQotmwGxVRx2cjIeInud.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/W42KbmVcZozYu3xCDLKc4Zc9ndf.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/KCGYbdLdLojsnqxafgUc6umTnPd.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/TBU2b8qGcobYnpxtTnOcGRidnDe.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/OnTVbtlSNo69fHxX6yxc4LUHnQe.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/NgDNb7QCVolcwox3LTXcX1Iqnvd.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/AGhPb6uK4oyHyMx5nG5cqycZnvd.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/EOSkbycFLoUbzOxDQxgcTQtmnje.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/LqAZbSYKLoAke8xMceLcQ6IjnEe.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/NA7mbfZEKomduexvZUXcBCm2nYc.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/WOQWbeBXKoqnQKxvCTjctR3FnNh.png)</span>

#### PDAF 定标步骤

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/FDUibp2uAoon7pxxXMRckoYJnEd.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/XjGFbPHPvog9dqxMMYzc69Zsnec.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/VbYvb8uExoZr3oxylbycmzhon88.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/Ru42bu2NQoRfcSxtqxacrgTDnAJ.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/QJerblj9loAfZUxFgquc500pnwc.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/B2wmbYVkfoTzx3xrE78cEYJknVe.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/LrvNbO5yioeg6Pxa3NLcbyYunJH.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/KYwJb2nmYowsqxx4YbbcECYAnee.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/Du34bsO1roaHMuxBUsIcZMQ8nNd.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/FzClb3bksoSX9OxRcLfcInZpn9e.png)</span>

- 亮度控制参数为 m_pSegG，0-8 共九组，其中第 8 组固定为 255 不可改，对应 VRF 数据像素值（映射到 8 比特），亮度处于两个节点之间时，参数为两个节点参数插值的结果，相邻两档间跨度须保证为 2 的整数幂，建议保持缺省值。

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/QjlsbDwzIoHbpTxTl3xc53zvnGc.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/JAlIbd1wAoKOfUxLK7Fc223ontg.png)</span>

- 参数随 Lum 变化插值说明

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/LNJCbJMKJocZrxxR9SEc7QgtnDc.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/JMPabWdtVomXsJx1sTnc7MnanLe.png)</span>

图 LSC-色温控制曲线

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/CHr0bp58jojXhaxbF8RcNveJnmh.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/GrX6bMFrCoPYUBx1zVUcAh6zn1f.png)</span>

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/S8vmbd56NoR3DHxROWMcN4YTnKb.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/QYi8bwTGhohuWixrKjycbeqDniV.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/ReeEbtPUyonDK3xyYSRcdCmInrh.png)</span>

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/JyuGbHVjXoGaCpxkFqtc627Vnwg.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/MjDzbshXVosldrx6y5hcvU7znie.png)</span>

R - CenterPercent 示意图

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/EKIfbxmProoJh7x3MfacWYF3n3d.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/YTpPbURsvoGK57xo5H8cz0SPnJe.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/KQExbr7SRoZaHxxuMdZc1mYnntf.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/UOFrbbfugowiQ0xGIFMcsYpinGg.png)</span>

图 LumThre-Gain 控制曲线

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/O295b9FmhoY1myxB0F5cqU7Zn2f.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/BIBybAjYiogHzmxrC6AcXIFun5c.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/L1MtbvrsSoBgR6xi8cmcjbGGnVg.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/GF87b77YCoFNpgxtHGmcTdnxnFb.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/Urz9bne0HomGpfxKoPIcRSvenUh.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/E25Abu0eSoVImrxg46xcwvH1nvZ.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/R0T8bjLECohzvwx6L1Gc7KVcntc.png)</span>

Exp_index – luma_weight 示意图

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/MEjWbGZNDoGc4axZxQrcUjLynEh.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/IvlIb6jdvoK7vQxEem0cjRKGnCb.png)</span>

Step – target 示意图

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/PJxXbFP5ho4oHcxLxmscehAEnKh.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/NBOHbysteo5NtQx9fv9cENVynhe.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/JeuSbzuDfoBgZmxPpjOc5eHBnIc.png)</span>

图 1

(每组 Conditions 条件描述-Graphic 图形演示-Output 输出为一种情况)

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/AMDjblfBJofaQIxIcKHcgVT0nzh.png)</span>

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/FJktbd8yLopteExp8ivcaZW8n8b.png)</span>

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/S8F1bZuBYodcpHxzpDIc4iIgnjd.png)</span>

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/PddBb82jNotOUTxV57ocFYK9n5d.png)</span>

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/N0j9bUukVos4qLx3bv5cMzRynAh.png)</span>

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/ANqibXzqqoGK0bxDiLeciB5Unxe.png)</span>

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/ARYubf6ZrovCCuxDdu4cDNvpnhb.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/CgoZbDxPfoa1Vyxg5pNcFFsJnjb.png)</span>

图 3

(每组 Conditions 条件描述-Graphic 图形演示-Output 输出为一种情况)

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/GQT7brkH5oXi1pxLVx5c8YAfnGf.png)</span>

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/HsXLbF68LoRnc6x1FVZcoxAunKf.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/XHjabVAXKoenQbxx9v7cRZl9nyh.png)</span>

CtThr – ProtectRatio 示意图

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/Yg4EbdPsCowxyOxyTA2cOY10nKc.png)</span>

lowCtLightPermillage-ratio 示意图

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/P8bMbljXaom7BGxzAVtcDoTtnPd.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/WSVvbAViHo5eKnx7pt1ctXomnMc.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/Z5TSbZah2o6nRpxjmhkcDnOHnQd.png)</span>

Uv_pf_gain – hue_pf 示意图

<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/JwAnbDkXsogvrrx3FUqcrRV3nOg.png)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![](./static/E4pVbaHrqoZDxcx4uojcke4OnCe.png)</span>
