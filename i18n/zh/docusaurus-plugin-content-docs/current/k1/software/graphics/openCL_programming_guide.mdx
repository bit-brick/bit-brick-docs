...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![opencl](./static/how_it_works.jpg#pic_center)</span>
...
<span style={{display: 'flex',justifyContent: 'center',margin: '10px 0'}}>![opencl](./static/executing_programs.jpg#pic_center)</span>
