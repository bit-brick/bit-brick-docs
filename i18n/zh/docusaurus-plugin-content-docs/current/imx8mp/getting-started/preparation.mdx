...
![power](/img/imx8mp/getting-started/preparation/power.png)
...
![sd_set](/img/imx8mp/getting-started/preparation/sd_set.png)
...
![keyboard](/img/imx8mp/getting-started/preparation/keyboard_connect.png)

## Mouse

You can use any of the USB ports on your PI one to connect a wired mouse or USB Bluetooth receiver.

![mouse](/img/imx8mp/getting-started/preparation/mouse_connect.png)
...
![display_hdmi](/img/imx8mp/getting-started/preparation/display_hdmi.png)
...
![network](/img/imx8mp/getting-started/preparation/networking.png)
...
![debugging](/img/imx8mp/getting-started/preparation/debugging_port.png)